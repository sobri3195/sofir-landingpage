...
const Authors = () => {
  const [authorsRef, isAuthorsVisible] = useIntersectionObserver({ threshold: 0.2 });
  ...
  const authors = [
    {
      ...
      image: 'https://ui-avatars.com/api/?name=Firman+Elhakim&size=200&background=3B82F6&color=fff&bold=true',
      social: {
        github: '#',
        linkedin: '#',
        twitter: '#'
    ...
    },
    {
      ...
      image: 'https://ui-avatars.com/api/?name=Muhammad+Sobri+Maulana&size=200&background=10B981&color=fff&bold=true',
      social: {
        github: '#',
        linkedin: '#',
        twitter: '#'
  ...
  return (
    <section 
      className={`authors ${isAuthorsVisible ? 'visible' : ''}`} 
      id="authors" 
      ref={authorsRef}
    >
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Tim berpengalaman yang membangun SOFIR dengan dedikasi dan passion
          </p>
        </div>
